...
public class edit1 extends HttpServlet
{
	public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException
	{
		try
		{
			...
			out.println("<td><input type='text' name='t1' value="+"'"+ rs.getString(3) + "'"+"></td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td width=50%>Gender</td>");
			out.println("<td><input type='text' name='t2' value="+"'"+ rs.getString(5) + "'"+"></td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td width=50%>Donar's Location</td>");
			out.println("<td><input type='text' name='t3' value='"+ rs.getString(6) + "'></td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td width=50%>Blood group</td>");
			out.println("<td><input type='text' name='t4' value='"+ rs.getString(7) + "'</td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td width=50%>Donar's Contact</td>");
			out.println("<td><input type='text' name='t5' value='"+ rs.getString(8) + "'</td>");
			out.println("</tr>");
